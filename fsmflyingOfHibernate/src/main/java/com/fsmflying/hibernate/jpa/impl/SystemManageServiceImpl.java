...
//@Service("jpaSystemManageService")
public class SystemManageServiceImpl implements ISystemManageService,HibernateJpaAccessable {
...
//		this.entityManager = entityManagerFactory.createEntityManager();
	...
	public List<SysCompany> getListOfSysCompany() {
		return (List<SysCompany>) this.entityManager.
				createQuery("select o from SysCompany o").
				getResultList();
	}
	...
	public List<SysDepartment> getListOfSysDepartment() {
		return (List<SysDepartment>) this.entityManager.
				createQuery("select o from SysDepartment o").
				getResultList();
	}
	...
	public List<SysEmployee> getListOfSysEmployee() {
		return (List<SysEmployee>) this.entityManager.
				createQuery("select o from SysEmployee o").
				getResultList();
	}
	...
	public List<SysMenu> getListOfSysMenu() {
		return (List<SysMenu>) this.entityManager.
				createQuery("select o from SysMenu o").
				getResultList();
	}
	...
	public List<SysFuncPoint> getListOfSysFuncPoint() {
		return (List<SysFuncPoint>) this.entityManager.
				createQuery("select o from SysFuncPoint o").
				getResultList();
	}
	...
	public List<SysConfig> getListOfSysConfig() {
		return (List<SysConfig>)this.entityManager.
				createQuery("select o from SysConfig o where o.dbDeleted=0").
				getResultList();
	}
	...
	public List<SysCustomPage> getListOfSysCustomPage() {
		return (List<SysCustomPage>) this.entityManager.
				createQuery("select o from SysCustomPage o").
				getResultList();
	}
	...
	public List<SysDataAuth> getListOfSysDataAuth() {
		return (List<SysDataAuth>) this.entityManager.
				createQuery("select o from SysDataAuth o").
				getResultList();
	}
	...
	public List<SysDataAuthItem> getListOfSysDataAuthItem() {
		return (List<SysDataAuthItem>) this.entityManager.
				createQuery("select o from SysDataAuthItem o").
				getResultList();
	}
	...
	public List<SysDictDir> getListOfSysDictDir() {
		return (List<SysDictDir>) this.entityManager.
				createQuery("select o from SysDictDir o").
				getResultList();
	}
	...
	public List<SysDictItem> getListOfSysDictItem() {
		return (List<SysDictItem>) this.entityManager.
				createQuery("select o from SysDictItem o").
				getResultList();
	}
	...
	public List<SysFile> getListOfSysFile() {
		return (List<SysFile>) this.entityManager.
				createQuery("select o from SysFile o").
				getResultList();
	}
	...
	public List<SysFuncPoint> getUserFuncPoints(int userId) {
		return (List<SysFuncPoint>)this.entityManager
				.createNativeQuery("select t.* from sys_funcpoints t inner join ("
	...
	public List<SysDataAuth> getUserDataAuths(int userId) {
		return (List<SysDataAuth>)this.entityManager
				.createNativeQuery("select t.* from sys_dataauths t inner join ("
	...
	public UserPermissions getUserPermissions(int userId) {
		...
		listResults = (List<Object[]>) entityManager
				.createNativeQuery("select c.funcPointId from sys_roles a inner join sys_ruserrole b on a.roleId=b.roleId "
...
//		Hibernate.initialize(listResults);
		...
		listResults = (List<Object[]>) entityManager
				.createNativeQuery("select c.authItemId from sys_roles a inner join sys_ruserrole b on a.roleId=b.roleId "
	...
	public List<SysMenu> getTabMenus(int tabId) {
		return (List<SysMenu>)this.entityManager
				.createNativeQuery("select t.* from sys_menus t inner join sys_rtabmenu r on t.menuid=r.menuid where dbdeleted=0 and r.tabId=:tabId",
						SysMenu.class)
